...
const reviews = [
  {
    ...
    location: "Toronto, ON",
    rating: 5,
    text: "Maple Clean transformed our home! As a busy mom of three, I never thought I'd find a cleaning service that meets my standards. They're thorough, punctual, and incredibly professional.",
    image: "/friendly-canadian-mom-casual-sweater-smiling-warml.jpg",
  },
  {
    name: "David Chen",
    location: "Vancouver, BC",
    rating: 5,
    text: "We've tried several cleaning services for our office, but Maple Clean is by far the best. The family-owned touch really shows in their attention to detail and customer care.",
    image: "/asian-canadian-man-casual-hoodie-friendly-smile-ou.jpg",
  },
  {
    name: "Emily Thompson",
    location: "Calgary, AB",
    ...
    image: "/young-blonde-woman-casual-tshirt-natural-smile-can.jpg",
  },
  {
    ...
    image: "/middle-aged-canadian-dad-flannel-shirt-friendly-be.jpg",
  },
  {
    name: "Jennifer Walsh",
    ...
    image: "/red-haired-woman-casual-cardigan-warm-smile-natura.jpg",
  },
  {
    name: "Robert Kim",
    ...
    image: "/korean-canadian-man-casual-jacket-friendly-natural.jpg",
  },
]
